...
public class EquipmentUIController : MonoBehaviour
{
    ...
    void ShowMaterialDetail(MaterialData material)
    {
        ...
        if (detailRarityImage != null)
            detailRarityImage.sprite = Resources.Load<Sprite>($"Picture/Material/Frame_{material.Stars}S");

        if (detailIconImage != null)
            detailIconImage.sprite = Resources.Load<Sprite>($"Picture/Material/Icon_{material.Id}");

        if (detailStarImage != null)
            detailStarImage.sprite = Resources.Load<Sprite>($"Picture/Stigmata/Stars_{material.Stars}S");
